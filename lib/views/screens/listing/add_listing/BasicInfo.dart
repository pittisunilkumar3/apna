...
// import 'package:searchfield/searchfield.dart';  // Temporarily commented out
                            ...
                            children: [
                              ...
                              if (ProfileController.to.isLeafLetMap == true)
                                if (manageListingCtrl.selectedCityId != null)
                                  // SearchField widget temporarily commented out
                                  Container(
                                    height: 50.h,
                                    ...
                                    child: Center(
                                      child: Text(
                                        storedLanguage['Search Place'] ?? "Search Place",
                                        style: TextStyle(
                                          color: AppColors.textFieldHintColor,
                                          fontSize: 14.sp,
                                        ),
